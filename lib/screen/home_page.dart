...
import 'package:randommenu/screen/result_page.dart';
import 'package:randommenu/widget/all_circle.dart';
import 'package:randommenu/widget/drawer.dart';
import 'package:randommenu/widget/food_circle.dart';
import 'package:randommenu/food_list.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        color: darkMode ? Color(0xff282828) : Colors.white,
        child: Container(
          child: Column(
            children: <Widget>[
              SizedBox(
